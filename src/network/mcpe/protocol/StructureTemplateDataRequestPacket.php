...
class StructureTemplateDataRequestPacket extends DataPacket implements ServerboundPacket{
	...
	protected function decodePayload(PacketSerializer $in) : void{
		...
		$this->structureBlockPosition = $in->getBlockPosition($in->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
	...
	protected function encodePayload(PacketSerializer $out) : void{
		...
		$out->putBlockPosition($this->structureBlockPosition, $out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
