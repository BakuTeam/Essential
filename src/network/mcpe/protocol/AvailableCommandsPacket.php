...
class AvailableCommandsPacket extends DataPacket implements ClientboundPacket{
	...
	public static function convertArg(int $protocolId, int $type) : int{
		...
		return match ($type) {
			...
			self::ARG_FLAG_VALID | self::ARG_TYPE_WILDCARD_INT => self::ARG_FLAG_VALID | 0x04,
			self::ARG_FLAG_VALID | self::ARG_TYPE_OPERATOR => self::ARG_FLAG_VALID | 0x05,
			self::ARG_FLAG_VALID | self::ARG_TYPE_COMPARE_OPERATOR => self::ARG_FLAG_VALID | 0x05,
			self::ARG_FLAG_VALID | self::ARG_TYPE_TARGET => self::ARG_FLAG_VALID | 0x06,
			self::ARG_FLAG_VALID | self::ARG_TYPE_WILDCARD_TARGET => self::ARG_FLAG_VALID | 0x07,
			self::ARG_FLAG_VALID | self::ARG_TYPE_FILEPATH => self::ARG_FLAG_VALID | 0x0e,
			self::ARG_FLAG_VALID | self::ARG_TYPE_FULL_INTEGER_RANGE,
			self::ARG_FLAG_VALID | self::ARG_TYPE_EQUIPMENT_SLOT,
			self::ARG_FLAG_VALID | self::ARG_TYPE_BLOCK_STATES,
			self::ARG_FLAG_VALID | self::ARG_TYPE_STRING => self::ARG_FLAG_VALID | 0x1d,
			self::ARG_FLAG_VALID | self::ARG_TYPE_INT_POSITION => self::ARG_FLAG_VALID | 0x25,
			self::ARG_FLAG_VALID | self::ARG_TYPE_POSITION => self::ARG_FLAG_VALID | 0x26,
			self::ARG_FLAG_VALID | self::ARG_TYPE_MESSAGE => self::ARG_FLAG_VALID | 0x29,
			self::ARG_FLAG_VALID | self::ARG_TYPE_RAWTEXT => self::ARG_FLAG_VALID | 0x2b,
			self::ARG_FLAG_VALID | self::ARG_TYPE_JSON => self::ARG_FLAG_VALID | 0x2f,
			self::ARG_FLAG_VALID | self::ARG_TYPE_COMMAND => self::ARG_FLAG_VALID | 0x36,
			default => $type,
		};
	}
