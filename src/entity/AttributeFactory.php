...
final class AttributeFactory{
	...
	public function get(string|int $id) : ?Attribute{
		return isset($this->attributes[$id]) ? clone $this->attributes[$id] : null;
	}

	public function mustGet(string|int $id) : Attribute{
		$result = $this->get($id);
		if($result === null){
	 ...
	 */
	public function register(string|int $id, float $minValue, float $maxValue, float $defaultValue, bool $shouldSend = true) : Attribute{
