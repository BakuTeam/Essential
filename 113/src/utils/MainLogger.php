...
class MainLogger extends AttachableThreadSafeLogger implements \BufferedLogger{
	...
	public function warning($message){
		$this->send($message, \LogLevel::WARNING, "Warn", TextFormat::YELLOW);
	}
	...
	protected function send(string $message, string $level, string $prefix, string $color) : void{
		...
		$message = sprintf($this->format, strtoupper($prefix), $threadName, $time->format("H:i:s"), $color, TextFormat::addBase($color, TextFormat::clean($message, false)));
