...
class UpdateSubChunkBlocksPacket extends DataPacket implements ClientboundPacket{
	...
	protected function decodePayload(PacketSerializer $in) : void{
		$this->baseBlockPosition = $in->getBlockPosition($in->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
		$this->layer0Updates = [];
	...
	protected function encodePayload(PacketSerializer $out) : void{
		$out->putBlockPosition($this->baseBlockPosition, $out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
