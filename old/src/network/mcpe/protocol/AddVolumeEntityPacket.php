...
class AddVolumeEntityPacket extends DataPacket implements ClientboundPacket{
	...
	protected function decodePayload(PacketSerializer $in) : void{
		...
		$this->minBound = $in->getBlockPosition($in->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
		$this->maxBound = $in->getBlockPosition($in->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
	...
	protected function encodePayload(PacketSerializer $out) : void{
		...
		$out->putBlockPosition($this->minBound, $out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
		$out->putBlockPosition($this->maxBound, $out->getProtocolId() >= ProtocolInfo::PROTOCOL_1_26_10);
